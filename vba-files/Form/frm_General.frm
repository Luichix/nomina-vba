...
MsgBox "Comprobante de pago elaborado con �xito!!!", vbInformation, Titulo
...
'DISE�O Y FORMATO DE LA ESTRUCTURA "COLOR Y CENTRADO
...
'DISE�O Y FORMATO DE ESTRUCTURA "BORDES"
...
Else
    MsgBox "No se indic� la carpeta donde guardar el PDF�" _
    & vbCrLf & vbCrLf & "Operaci�n cancelada.", _
...
If Len(Dir(mi_carpeta)) > 0 Then
    ...
    If Err.Number <> 0 Then
        MsgBox "El archivo pdf se encuentra abierto o protegido como s�lo lectura." _
