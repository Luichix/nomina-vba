...
Private Sub txt_Id_KeyPress(Byval KeyAscii As MSForms.ReturnInteger)
    KeyAscii = ValidateDecimal(Me.txt_Id, KeyAscii)
End Sub

Private Sub txt_Salario_KeyPress(Byval KeyAscii As MSForms.ReturnInteger)
    KeyAscii = ValidateDecimal(Me.txt_Salario, KeyAscii)
End Sub
...
Private Sub btn_Registrar_Click()
    ...
    If Me.txt_Id.Text = Empty Or _
        ...
        MsgBox "Hay campos vac�os en el registro..!", vbInformation, Titulo
     Exit Sub
...
Private Sub btn_Accion_Click()
    ...
    If Me.txt_Aid.Text = "" Then
        ...
        MsgBox "Seleccione el c�digo del personal..!", vbInformation, Titulo
